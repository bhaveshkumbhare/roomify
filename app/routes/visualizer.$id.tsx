...
import { renderMatches, useLocation, useNavigate, useOutletContext, useParams } from 'react-router'
...
const handleExport = async () => {
  ...
  try {
    ...
    link.href = blobUrl;
    link.download = `roomify-${project?.name || id || "render"}.png`;
...
const runGeneration = async (item: DesignItem) => {
  if(!id || !item.sourceImage) return ;
    try {
      ...
      console.log('Generation Falied', error)
    }finally{
          ...
          <div className="compare-stage">
            {project?.sourceImage && currentImage ? (
              ...
              <div className='compare-fallback'>
                {project?.sourceImage &&(
                  <img src={project.sourceImage} alt="Before"  className='compare-image'/>
                )}
              </div>
            )}
          </div>
